...
const cardData = [
  ...
  },
  {
    ...
    image: '/pictures/Utkrushta.jpeg',
    title: 'To Rachel Green',
  ...
  },
  {
    name: 'Mahek',
    position: 'Ex - Secretary',
    image: '/pictures/Mahek.png',
    title: 'To the Donna Paulsen',
...
},
{
  ...
  {
    name: 'Khushi',
    position: 'Ex - Events HOD',
    image: '/pictures/Khushi.png',
    title: 'To the OG Ayojan Karta',
...
},
{
  ...
  {
    name: 'Bhargav',
    position: 'Ex - Techinal HOD',
    image: '/pictures/Bhargav.jpeg',
    title: 'To Panditji',
  ...
  },
  {
    name: 'Het',
    position: 'Ex - Techinal HOD',
    image: '/pictures/Het.png',
    title: 'To the Actual Danger of the Heart',
  ...
  {
    name: 'Jiya',
    position: 'Ex - Editorial HOD',
    image: '/pictures/Jiya.png',
    title: 'To the OG Lekhika',
...
{
    name: 'Preem', 
    position: 'Ex - Publicity HOD',
    image: '/pictures/Preem.jpeg',
    title: 'To the Babygurl',
...
{
    name: 'Hussain',
    position: 'Ex - Logistic HOD',
    image: '/pictures/Hussain.png',
    title: 'To the OG Majdoor',
...
},
{
    name: 'Vraj',
    position: 'Ex - Logistic HOD',
    image: '/pictures/Vraj.png',
    title: 'To the Majdoor ki Jodi',
...
return (
  <div className="flex flex-col w-full justify-center container mx-auto px-4 py-5 md:py-2">
    <div className="flex flex-wrap justify-center gap-4 md:gap-6 mb-2" id="cards-container">
